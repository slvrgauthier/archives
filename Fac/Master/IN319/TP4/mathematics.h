...
int Jacobi(float M[3][3],float e[3],float E[3][3])
{
...
int ClosestRigid(float K[3][3],float R[3][3])
{
    float KTK[3][3];
    ...
    float eT[3][3] = {{e[0]*T[0][0],	e[0]*T[1][0],	e[0]*T[2][0] }  ,{e[1]*T[0][1],	e[1]*T[1][1],	e[1]*T[2][1]}, { e[2]*T[0][2],e[2]*T[1][2],e[2]*T[2][2]}};
    float KTKm12[3][3]; Mult(KTKm12,T,eT);
    Mult(R,K,KTKm12);
