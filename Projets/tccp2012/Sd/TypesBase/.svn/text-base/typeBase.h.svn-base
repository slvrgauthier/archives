...
/**
 * \brief Struture globale à tous les types (équivalent à un void*)  : 
 * Strutures internes qui représentent tous les types. 
 */
...
/**
 * \brief Structure entier : 
 * Structure interne gérant les Entiers. Cette structure n'est pas manipulable par l'utilisateur. 
 */
typedef struct entier* entier;
/**
 * \brief Strutures flottant : 
 * Structure interne gérant les Flottants. Cette structure n'est pas manipulable par l'utilisateur.
 */
typedef struct flottant* flottant;
/**
 * \brief Strutures car : 
 * Structure interne gérant les Car. Cette structure n'est pas manipulable par l'utilisateur.
 */
typedef struct car* car;
/**
 * \brief Strutures String : 
 *  Structure interne gérant les String. Cette structure n'est pas manipulable par l'utilisateur. 
 */
