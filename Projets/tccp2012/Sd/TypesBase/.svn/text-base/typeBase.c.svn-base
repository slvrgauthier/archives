...
/**
 * @brief Le constructeur Entier :
 *Ce constructeur va nous permettre de créer une variable de type Entier avec la syntaxe suivante : 
 Entier <variable> = Entier_Creer(<valeur>).
 * @param valeur La valeur à stocker dans la variable.
 * @return valeur déclarée dans un type Entier.
 */
...
/**
 * @brief Le constructeur Flottant :
 *Ce constructeur va nous permettre de créer une variable de type Flottant avec la syntaxe suivante : 
 Flottant <variable> = Flottant_Creer(<valeur>).
 * @param valeur La valeur à stocker dans la variable.
 * @return valeur déclarée dans un type Flotant.
 */
...
/**
 * @brief Le constructeur Car :
 *Ce constructeur va nous permettre de créer une variable de type Car avec la syntaxe suivante : 
 Car <variable> = Car_Creer(<valeur>).                                                               
 * @param valeur La valeur à stocker dans la variable.
 * @return valeur déclarée dans un type Car.
 */
...
/**
 * @brief Le constructeur String :
 *Ce constructeur va nous permettre de créer une variable de type String avec la syntaxe suivante : 
 String <variable> = String_Creer(<valeur>).
 * @param valeur La valeur à stocker dans la variable.
 * @return valeur déclarée dans un type String.
 */
 ...
 * @return un String result si cela marche sinon renvoie NULL .
 */
 ...
 * @param indice L'indice du caractère à récupérer dans la chaine de caractères.
